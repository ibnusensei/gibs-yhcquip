                ...
                <div class="card-body">
                    ...
                    <form action="{{ $url }}" method="POST">
                        ...
                        <div class="form-group row mb-1">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="name[]" value="{{ old('name', @$gainer->name) }}"placeholder="Enter Name, Ex: Fulan" required>
                            </div>
                            <div class="col-sm-1">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9"><input type="text" class="form-control" name="from[]" value="{{ old('from', @$gainer->from) }}"placeholder="From..., Ex: Jakarta" required>
                        </div>
