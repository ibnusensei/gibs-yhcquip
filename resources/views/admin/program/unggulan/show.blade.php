    ...
    <div class="content container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <form action="{{ route('admin.unggulan.image.store', $unggulans) }}" method="POST"
        ...
        <div class="card">
            <div class="card-body">
                ...
                {{-- media --}}
                <div class="row ">
                    @foreach ($unggulans->getMedia('images') as $image)
                        <div class="col-md-4 mb-4">
                            <div class="img-custom rounded mb-2">
                                <img src="{{ $image->getUrl() }}" class="" alt="">
                            </div>
                            <form action="{{ route('admin.unggulan.image.destroy', $image) }}" method="POST" class="d-inline">
                                @method('DELETE')
                                @csrf
