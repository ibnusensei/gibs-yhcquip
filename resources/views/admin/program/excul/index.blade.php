                        ...
                        <tbody class="table-align-middle">
                            @forelse ($exculs as $excul)
                                <tr>
                                    ...
                                    <td>
                                        <form class="publishForm" action="{{ route('admin.excul.publish', $excul->id) }}" method="POST">
                                            @csrf
                                            <div class="form-check form-switch">
                                                <input class="form-check-input publishSwitch" type="checkbox" name="is_published" {{ $excul->is_published ? 'checked' : '' }}>
                                                {{-- <label class="form-check-label" for="publishSwitch">{{ $excul->is_published ? '' : '' }}</label> --}}
                                            </div>
                                        </form>
                                    </td>
                                    <td>
