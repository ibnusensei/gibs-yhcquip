<x-app-layout>
    ...
    <div class="content container-fluid">
        ...
        <div>
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-3 card-title">{{ @$job ? 'Edit' : 'Create' }} job</h4>
                    <form action="{{ $url }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="posisi" class="form-control" name="posisi"
                                placeholder="Posisi" value="{{ @$job->posisi}}">
                        </div>

                        <div class="mb-3">
                            <label class="form-label" for="unit">Unit</label>
                            <input type="text" id="unit" class="form-control" name="unit"
                                placeholder="Unit" value="{{ @$job->unit}}">
                        </div>

                        <div class="mb-3">
                            <label class="form-label" for="description">Description</label>
                            <textarea id="editor" name="description" class="form-control" placeholder="Textarea field" rows="4">{{ @$job->description }}</textarea>
                        </div>

                        <!-- Flatpickr -->
                        <div class="mb-3">
                            <label class="form-label" for="start_date">start_date</label>
                            <input type="text" name="start_date" class="js-flatpickr form-control flatpickr-custom" placeholder="Select start_date" value="{{ @$job->start_date }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="end_date" class="js-flatpickr form-control flatpickr-custom" placeholder="Select end_date" value="{{ @$job->end_date }}"
                            data-hs-flatpickr-options='{
                                "dateFormat": "d/m/Y"
                            }'>
                        ...
                        <div class="mb-3" id="preview">
                            @if (@$job && $job->hasMedia('image'))
                                <img src="{{ $job->getFirstMediaUrl('image', 'thumb') }}" alt="">
